...
print("version : Pre-Alpha Test 1.2")
print("")
...
dial0 = pygame.mixer.Sound("Audio/Dialtone/Normal.wav")
dial0.set_volume(0.1)
dial1 = pygame.mixer.Sound("Audio/Dialtone/High.wav")
...
def shared_function():
    ...
    def fast_print_high(text, delay=0.05):
        for char in text:
            sys.stdout.write(char)
            sys.stdout.flush()
            time.sleep(delay)
            dial1.play()
            dial1.set_volume(0.5)
        print()
        return fast_print_high
    ...
    return fast_print_high, fast_print, normal_print, slow_print

fast_print_high, fast_print, normal_print, slow_print = shared_function()
...
def TerraMythos():
    ...
    def testing():
        ...
        time.sleep(1)
        fast_print_high("testing one two three four five")
        time.sleep(1)
    ...
    def chapter1():
        def the_hunt():
            ...
            time.sleep(1)
            print("mary :", end="")
            fast_print_high("'The boar should be here somewhere....'")
            time.sleep(1)
            print("mary :", end="")
            fast_print_high("'Maybe right around the corner.'")
            time.sleep(1)
            ...
            time.sleep(1)
            print("Mary :", end="")
            fast_print_high("'Found it!'")
            time.sleep(1)
            fast_print("You walked through the bushes in stealth.")
            time.sleep(1)
            print("Mary :", end="")
            fast_print_high("'There you are!'")
            time.sleep(1)
            ...
            time.sleep(1)
            print("Mary :", end="")
            fast_print_high("'That's some real meat over here...'")
            time.sleep(1)
            print("End of current testing...")
